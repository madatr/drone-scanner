...
class Authenticator {
  ...
  static AuthResult? checkAuth(List<MessageContainer> allMessages) {
    if (allMessages.isNotEmpty) {
      log("Auth Check: allMessages.isNotEmpty");
      if (allMessages.fold(
          false,
          (previousValue, element) =>
              element.authenticationMessage != null || previousValue)) {
        log("Auth Check: messages contain some auth");
        ...
        if (allMessages.last.selfIdMessage != null) {
          if (allMessages.last.selfIdMessage!.description != "") {
            ...
            var txTime = parseTime(
                allMessages.last.selfIdMessage!.description.toString());
        ...
        if (allMessages.last.postProcessTime != null) {
          log("message after processing time: ${allMessages.last.postProcessTime!.toIso8601String()}");
          pt = allMessages.last.postProcessTime!
        ...
        if (allMessages.last.authenticationMessage != null &&
          ...
          var payload = allMessages
              .last.authenticationMessage!.authData.authData
              .toHexString();
          ...
          if (payload.isNotEmpty || payload.length == 256) {
            ...
            result.verificationMessage =
                "Auth payload wrong length: ${payload.length}";
            return result;
          }
          ...
          try {
            ...
            result.verificationMessage = "${e.toString()}";
            ec = getSecp256k1();
          ...
          try {
            ...
            result.verificationMessage =
                "Signature Parsing Error: ${e.toString()}";
            return result;
          }
          bool vres;
          try {
